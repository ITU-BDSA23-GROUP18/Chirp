...
public class ReactionRepository_Tests
{
    ...
    {
        IReactionRepository _repository = null;
        var reactionStrings = _repository.GetAllReactionTypes();
        
        var reactionTypes = reactionStrings.Select(r => Enum.Parse<ReactionType>(r));
